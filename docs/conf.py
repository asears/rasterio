...
latex_documents = [
    (master_doc, "rasterio.tex", u"rasterio Documentation", u"Sean Gillies", "manual"),
]
...
man_pages = [(master_doc, "rasterio", u"rasterio Documentation", [author], 1)]
