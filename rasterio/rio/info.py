...
@click.option("--tags", "aspect", flag_value="tags", help="Show data file tags.")
...
# a string.
@click.option(
    "--count", "meta_member", flag_value="count", help="Print the count of bands."
)
@click.option(
    "-t", "--dtype", "meta_member", flag_value="dtype", help="Print the dtype name."
)
@click.option(
    "--nodata", "meta_member", flag_value="nodata", help="Print the nodata value."
)
@click.option(
    "-f",
    "--format",
...
@click.option(
    "-r", "--res", "meta_member", flag_value="res", help="Print pixel width and height."
)
@click.option(
    "--lnglat",
    "meta_member",
...
@click.option(
    ...
    "meta_member",
    flag_value="stats",
    help="Print statistics (min, max, mean) of a single band " "(use --bidx).",
)
@click.option(
    "--checksum",
    "meta_member",
    flag_value="checksum",
    help="Print integer checksum of a single band " "(use --bidx).",
)
@click.option(
    "--subdatasets",
    "meta_member",
    flag_value="subdatasets",
...
@options.masked_opt
@click.pass_context
def info(ctx, input, aspect, indent, namespace, meta_member, verbose, bidx, masked):
